...
pub enum WireApi {
    ...
    #[default]
    Responses,
    /// The classic Chat Completions API exposed at `/v1/chat/completions`.
    /// Restored for OpenAI-compatible endpoints (e.g. Alibaba Cloud MaaS and
    /// other domestic providers) that only implement the chat protocol.
    Chat,
}
